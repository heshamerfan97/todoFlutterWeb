...
/// The callback used by [MyRefreshableReorderableListView] to move an item to a new
/// position in a list.
///
...
/// [MyRefreshableReorderableListView] will need to account for this when inserting before
/// [newIndex].
///
...
///
/// {@youtube 560 315 https://www.youtube.com/watch?v=3fB1mxOsqJE}
class MyRefreshableReorderableListView extends StatefulWidget {

  /// Creates a reorderable list.
  MyRefreshableReorderableListView({
    Key key,
    this.header,
  ...
  /// underlying list.
  ///
  /// This [MyRefreshableReorderableListView] calls [onReorder] after a list child is dropped
  /// into a new position.
  final ReorderCallback onReorder;

  @override
  _MyRefreshableReorderableListViewState createState() => _MyRefreshableReorderableListViewState();
}
...
class _MyRefreshableReorderableListViewState extends State<MyRefreshableReorderableListView> {
  // We use an inner overlay so that the dragging list item doesn't draw outside of the list itself.
  final GlobalKey _overlayKey = GlobalKey(debugLabel: '$MyRefreshableReorderableListView overlay key');
